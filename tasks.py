...
# Builds and installs libfaketime from @rgacgne's fork.
# FIXME: Update once https://github.com/wolfcw/libfaketime/pull/526 is merged and a new tag is created
def build_and_install_libfaketime(c):
    c.run(f'git clone https://github.com/rgacogne/libfaketime.git {repo_home}/libfaketime')
    with c.cd(f'{repo_home}/libfaketime'):
        c.run('git checkout fix-preload-hang-521')
